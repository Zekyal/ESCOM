...
#include "TADColaEst.h" //Se usa la implementación estática (TADColaEst.h)
...
int main()
{
	...
	Initialize(&listos);//Inicialización de la cola "Listos"
	Initialize(&finalizados);//Inicialización de la cola "Finalizados"
	...
	while(!Empty(&finalizados))//Muestra los elementos ya finalizados
	{
