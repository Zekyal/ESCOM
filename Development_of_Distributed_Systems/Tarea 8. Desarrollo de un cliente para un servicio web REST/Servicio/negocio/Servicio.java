...
public class Servicio
{
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Produces(MediaType.APPLICATION_JSON)
  public Response consulta_usuario(@FormParam("id_usuario") String id_usuario) throws Exception
  {
    Connection conexion= pool.getConnection();
  ...
  public Response modifica_usuario(@FormParam("usuario") Usuario usuario) throws Exception
  {
    ...
    try
    {
      PreparedStatement stmt_1 = conexion.prepareStatement("UPDATE usuarios SET nombre=?,apellido_paterno=?,apellido_materno=?,fecha_nacimiento=?,telefono=?,genero=? WHERE id_usuario=?");
      try
      {
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Produces(MediaType.APPLICATION_JSON)
  public Response borra_usuario(@FormParam("id_usuario") String id_usuario) throws Exception
  {
    Connection conexion= pool.getConnection();
    ...
    try
    {
      ...
      PreparedStatement stmt_2 = conexion.prepareStatement("DELETE FROM fotos_usuarios WHERE id_usuario=(SELECT id_usuario FROM usuarios WHERE id_usuario=?)");
      try
      {
        stmt_2.setString(1,id_usuario);
	stmt_2.executeUpdate();
      }
      finally
      {
