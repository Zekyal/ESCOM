...
class Usuario {
    ...
    String getId() { return this.id_usuario; }
    ...
    void setId(String id_usuario) { this.id_usuario = id_usuario; }
    ...
    static class Servicio {
        ...
        private final static String URL_MAQUINA = "http://13.65.145.13:8080/Servicio/rest/ws/";
    ...
    static class Menu {
        ...
        private void consultaUsuario() {
            ...
            try {
                ...
                Respuesta response = Servicio.hacerConsulta(cuerpo, GET_METHOD, "consulta", "id_usuario");
