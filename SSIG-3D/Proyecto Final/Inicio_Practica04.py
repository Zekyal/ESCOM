# Práctica 04. Variación 2 del Tiro Parabólico. (SSIS-3D)
...
class Prac04(QMainWindow):
    ...
    def cerrarVentana(self):
        if hasattr(self, 'graficaVectPos'):
            self.graficaVectPos.cerrarGraf()
            self.graficaVectVel.cerrarGraf()
        self.parent().show()
        self.close()
