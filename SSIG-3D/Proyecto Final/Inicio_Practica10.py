# Práctica 10. Cosenos Directores 2.0. (SSIS-3D) (Repetida de los módulos, quitar?)
...
from Grafica_Practica10 import Cosenos_directores
...
class Prac10(QMainWindow):
    ...
    def calcularValores(self):
        ...
        self.graficaCos.graficar_vector_cos(rx, ry, rz, magnitud)   # Trabajamos con la gráfica
