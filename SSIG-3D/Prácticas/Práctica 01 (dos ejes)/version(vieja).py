...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def obtenerGrado(self): 
        grado_poli = float(self.spin_grado.text())  # Toma el valor del boton spin_grado
        ...
        if grado_poli == 0:  # En caso de escoger un polinomio de grado 0
                ...
                self.dSpinBox_00.setMinimum(1)       # Pone un limite para los botones de las constantes
                self.dSpinBox_01.setMinimum(0)
                self.dSpinBox_02.setMinimum(0)
                self.dSpinBox_03.setMinimum(0)
                self.dSpinBox_04.setMinimum(0)
                self.dSpinBox_05.setMinimum(0)
                self.dSpinBox_01.setProperty("value", 0)     # Regresa los botones a sus valores de default (0)
