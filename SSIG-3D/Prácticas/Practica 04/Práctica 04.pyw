...
from Tiro_Parabolico2 import Canvas_grafica, Canvas_grafica2  # Archivo para realizar las gráficas

qtCreatorFile = "Practica04.ui" # Nombre del archivo aquí. Relative Path
