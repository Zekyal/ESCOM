...
class Cosenos_directores(FigureCanvas):
    ...
    def graficar_vector_cos(self, magnitud, rx, ry, rz):    
        ...
        #ax.quiver(0,0,0, rx, ry, rz, arrow_length_ratio=0.1, label='Vector', color = 'black', pivot = 'tail', linewidth = 1 )

        #mutation_scale = max(arx, ary, arz) / 10.0
        #ax.quiver(0, 0, 0, rx, ry, rz, arrow_length_ratio=0.1, label='Vector', color='black', mutation_scale=max(arx, ary, arz) / 10.0)
        ...
        #========================================================================
        # nombre del vector
        self.ax.text(rx1, ry1, rz1, f"({rx},{ry},{rz})", style='normal', fontweight='normal', color = 'blue')
        ...
        # nombres de los ejes
        self.ax.text(rx/2, 0, 0, 'rx_i', style='italic', fontweight='bold', color = "black")
        self.ax.text(0, ry/2, 0, 'ry_j', style='italic', fontweight='bold', color = "black")
        self.ax.text(0, 0, rz/2, 'rz_k', style='italic', fontweight='bold', color = "black")
        ...
        self.ax.plot(X, Y, Z, color = "green", label = 'α')
        ...
        self.ax.plot(X, Y, Z, color = "blue", label = 'ɣ')
        ...
        self.ax.plot(X, Y, Z, color = "red", label = 'β')
