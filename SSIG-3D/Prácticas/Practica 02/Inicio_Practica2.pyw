...
from Tiro_parabolico import Canvas_grafica  # Archivo para realizar las gráficas
import Errores02    # Archivo con los mensajes de error

qtCreatorFile = "Practica02.ui" # Nombre del archivo aquí. Relative Path
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def insertar_usuario(self):
        ...
        if usuario == '':     # En caso de no insertar usuario
            Errores02.Error_Usuario(self)   # Muestra el mensaje de error      
        else:
    ...
    def ver_gif(self):
        wb.open_new('Grafica\Tiro Parabolico.gif')
