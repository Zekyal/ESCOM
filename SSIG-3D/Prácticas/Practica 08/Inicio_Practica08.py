...
qtCreatorFile = "Practica08.ui" # Nombre del archivo aquí. Relative Path
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def graficarCaidaLibre(self):
        ...
        for t in range(0, int(tiempo)*10 + 1, 1):    # Hacemos las 20 repeticiones para guardar los valores en la tabla
            ...
            pos.append(Yo + Voy*t + -1/2*g*float(pow(t/10, 2)))   # Ingresa los valores a la lista "pos", haciendo las sustituciones en el polinomio de X
