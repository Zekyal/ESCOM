...
ax.plot_surface(x, y, z, color='skyblue', alpha=0.3, rstride=1, cstride=1)

# Dibujar el elipsoide con un color verde suave y cierta transparencia
ax.plot_surface(x_elipsoide, y_elipsoide, z_elipsoide, color='orange', alpha=0.2, rstride=1, cstride=1)
...
ax.scatter(x_3, y_3, z_3, color='green', s=1, alpha=0.5)
...
ax.scatter(x_intersect1, y_intersect1, z_intersect1, color='red', s=1, alpha=1)
...
ax.set_title(f"Proyección del ángulo sólido de una esfera sobre un elipsoide = {solid_angle:.2f} π estereorradianes")
