...
class Ley_Gauss(FigureCanvas):
    ...
    #------------ Grafica de Gauss de muestra ----------------------------------------------------------------------------------------------------------------
    def graficar_gauss_muestra(self, valor):    
    ...
    #------------ Grafica de Gauss de muestra (FIN) ----------------------------------------------------------------------------------------------------------
...
class Angulo_Solido(FigureCanvas):
    ...
    #------------ Grafica de Solido de muestra ----------------------------------------------------------------------------------------------------------------
    def graficar_solido_muestra(self):    
        # Parámetros de la esfera y el cono
        radius = 1
        theta_cone = np.pi / 10  # Ángulo theta respecto al eje Z (30 grados en este caso)
        solid_angle = 2 * np.pi * (1 - np.cos(theta_cone))
        ...
        plt.tight_layout()
    #------------ Grafica de Ángulo Sólido de muestra (FIN) ----------------------------------------------------------------------------------------------------------

    #------------ Grafica de Ángulo Sólido ---------------------------------------------------------------------------------------------------------------------------
    def graficar_solido(self, theta_cone):   
