...
class Camp_Magne_Cables_Par(FigureCanvas):
    ...
    def graficar_muestra(self):    
        ...
        def plot_magnetic_field(current_direction):
            ...
            self.ax.plot([1, 1], [0, 0], [-2, 2], 'k-', linewidth=5, color=(0.5, 0.5, 0.5, 0.5), label='Cable infinito 1')
            self.ax.plot([-1, -1], [0, 0], [-2, 2], 'k-', linewidth=5, color=(0.5, 0.5, 0.5, 0.5), label='Cable infinito 2')
