...
public class Cliente extends JFrame implements Runnable{  
    ...
    private void LogIn(){
        ...
        try{
            ...
            ByteArrayOutputStream baos = new ByteArrayOutputStream(DGRAM_BUF_LEN);
        ...
        try {
            ...
            if(msg.tipo.equals("INICIO")){   
                ...
                for(int i=0; i<numUsuarios; i++){
                    ...
                    if(!users.contains(new String(packet3.getData()).trim()))
                        users.add(new String(packet3.getData()).trim());
                }
            ...
            //Mensaje Privado a un usuario del grupo en particular
                ...
                //System.out.println(msg.usuarioDestino+": "+usuarioDestino.length()+" "+nombreUsuario+": "+nombreUsuario.length());
