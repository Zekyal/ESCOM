...
; 0000 0038 // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=P
; 0000 0039 PORTD=0x01;
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 003A DDRD=0x00;
	LDI  R30,LOW(0)
...
_0x4:
; 0000 0087       {
; 0000 0088       if(boton==0)
	SBIS 0x10,0
; 0000 0089         var1++;
	INC  R5
; 0000 008A       if(var1==10)
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x8
; 0000 008B         var1=0;
	CLR  R5
; 0000 008C 
; 0000 008D       PORTB=tabla7segmentos[var1];
_0x8:
	MOV  R30,R5
	LDI  R31,0
