...
;#include <mega8535.h>
	...
	#endif
;#include <delay.h>
;#define boton PIND.0  //Etiqueta el Pin 0 del Puerto D -> boton
;
;bit botonp;//Artificio para hacer la detección de los flancos
...
; 0000 003A // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=P
; 0000 003B PORTD=0x01;
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 003C DDRD=0x00;
	LDI  R30,LOW(0)
...
_0x11:
	BLD  R2,1
; 0000 008E 
; 0000 008F       if((botonp==1)&&(botona==0))//hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xA
	LDI  R26,0
	SBRC R2,1
...
_0xB:
; 0000 0090         {
; 0000 0091         var++;//se incrementa la var1iable
	INC  R5
; 0000 0092 
; 0000 0093         if(var==10)
	LDI  R30,LOW(10)
...
; 0000 0094             var=0;
	CLR  R5
; 0000 0095 
; 0000 0096         delay_ms(40);//se coloca retardo de 40ms para eliminar rebotes
_0xC:
	RCALL SUBOPT_0x0
; 0000 0097         }
; 0000 0098       if((botonp==0)&&(botona==1))//hubo cambio de flanco de 0 a 1
_0x9:
	LDI  R26,0
	SBRC R2,0
	LDI  R26,1
...
_0xE:
	RJMP _0xD
_0xF:
; 0000 0099         delay_ms(40);
	RCALL SUBOPT_0x0
; 0000 009A 
; 0000 009B       PORTB=tabla7segmentos[var];
_0xD:
	MOV  R30,R5
	LDI  R31,0
