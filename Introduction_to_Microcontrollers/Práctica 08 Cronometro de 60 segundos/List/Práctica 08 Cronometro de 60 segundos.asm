...
;#include <mega8535.h>
	...
	#endif
;#include <delay.h>
;#define reset PIND.0 //Etiqueta para el pin donde estará el botón RESET
;#define stop PIND.1 //Etiqueta para el pin donde estará el botón STOP
;#define start PIND.2 //Etiqueta para el pin donde estará el botón START
;
;bit botonp=1;//Artificio para hacer la detección de los flancos
;bit botona;//Artificio para hacer la detección de los flancos
;bit bandera=1;
;unsigned char varDecenas, varUnidades, varMilesimas;
...
; 0000 003D // State7=T State6=T State5=T State4=T State3=T State2=P State1=P State0=P
; 0000 003E PORTD=0x07;
	LDI  R30,LOW(7)
	OUT  0x12,R30
; 0000 003F DDRD=0x00;
	LDI  R30,LOW(0)
...
_0x4:
; 0000 008C       {
; 0000 008D       if(start==0)
	SBIC 0x10,2
	RJMP _0x7
; 0000 008E         botona=0;
	CLT
	RJMP _0x19
; 0000 008F       else if(stop==0){
_0x7:
	SBIC 0x10,1
	RJMP _0x9
; 0000 0090         botona=1;
...
; 0000 0097       else
	RJMP _0xC
_0xB:
; 0000 0098         botona=botonp;
	BST  R2,0
_0x19:
	BLD  R2,1
; 0000 0099 
; 0000 009A       //Boton START
; 0000 009B       if(botona==0)  {
_0xC:
_0xA:
	SBRC R2,1
	RJMP _0xD
; 0000 009C         if(varMilesimas==9){
	LDI  R30,LOW(9)
	CP   R30,R7
	BRNE _0xE
; 0000 009D             if(varUnidades==9){
	CP   R30,R4
	BRNE _0xF
; 0000 009E                 varDecenas++;
	INC  R5
; 0000 009F                 varUnidades=0;
	CLR  R4
; 0000 00A0 
; 0000 00A1                 if(varDecenas==6 && varUnidades==0){
	LDI  R30,LOW(6)
	CP   R30,R5
	BRNE _0x11
	LDI  R30,LOW(0)
...
_0x11:
	RJMP _0x10
_0x12:
; 0000 00A2                     varDecenas=0;
	CLR  R5
; 0000 00A3                     varUnidades=0;
	CLR  R4
; 0000 00A4                 }
; 0000 00A5             }
_0x10:
; 0000 00A6             else
	RJMP _0x13
_0xF:
; 0000 00A7                 varUnidades++;
	INC  R4
; 0000 00A8 
; 0000 00A9             varMilesimas=0;
_0x13:
	CLR  R7
; 0000 00AA             delay_ms(100);
	RCALL SUBOPT_0x0
; 0000 00AB             PORTA=tabla7segmentos[varDecenas];
	RCALL SUBOPT_0x1
; 0000 00AC             PORTB=tabla7segmentos[varUnidades];
; 0000 00AD         }
; 0000 00AE         else
	RJMP _0x14
_0xE:
; 0000 00AF             varMilesimas++;
	INC  R7
; 0000 00B0 
; 0000 00B1         delay_ms(100);
_0x14:
	RCALL SUBOPT_0x0
; 0000 00B2         PORTC=tabla7segmentos[varMilesimas];
	RCALL SUBOPT_0x2
; 0000 00B3       }
; 0000 00B4       else {
	RJMP _0x15
_0xD:
; 0000 00B5         //Boton STOP
; 0000 00B6         if(bandera==0){
	SBRC R2,2
	RJMP _0x16
; 0000 00B7             PORTA=tabla7segmentos[varDecenas];
	RCALL SUBOPT_0x1
; 0000 00B8             PORTB=tabla7segmentos[varUnidades];
; 0000 00B9             PORTC=tabla7segmentos[varMilesimas];
	RCALL SUBOPT_0x2
; 0000 00BA         }
; 0000 00BB         //Boton RESET
; 0000 00BC         else{
	RJMP _0x17
_0x16:
; 0000 00BD             PORTA=tabla7segmentos[0];
	LDS  R30,_tabla7segmentos
	OUT  0x1B,R30
; 0000 00BE             PORTB=tabla7segmentos[0];
	OUT  0x18,R30
; 0000 00BF             PORTC=tabla7segmentos[0];
	OUT  0x15,R30
; 0000 00C0             varDecenas=0;
	CLR  R5
; 0000 00C1             varUnidades=0;
	CLR  R4
; 0000 00C2             varMilesimas=0;
	CLR  R7
; 0000 00C3         }
_0x17:
; 0000 00C4       }
