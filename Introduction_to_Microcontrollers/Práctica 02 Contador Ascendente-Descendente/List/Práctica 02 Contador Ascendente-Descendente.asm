...
;Chip type               : ATmega8535
;Program type            : Application
;AVR Core Clock frequency: 1.001000 MHz
;Memory model            : Small
;External RAM size       : 0
;Data Stack size         : 128
;*****************************************************/
...
; 0000 002A // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
...
; 0000 0087         PORTB++; //incrementa valor de puerto en una unidad
	IN   R30,0x18
	SUBI R30,-LOW(1)
	OUT  0x18,R30
; 0000 0088         PORTD--; //decrementa valor de puerto en una unidad
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
; 0000 0089         delay_ms(250); //retardo que se genera para visualizar la información
	LDI  R30,LOW(250)
	LDI  R31,HIGH(250)
	ST   -Y,R31
	ST   -Y,R30
