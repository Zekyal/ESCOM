...
if (isset($_POST['borrar'])) {
    ...
    $Informacion = Borrar_Especialidad($ID_Especialidad);
}
?>
    ...
    <div class="container-fluid" id="Principal">
        ...
        <div id="Contenido" style="margin-left: 25%; margin-right:5%;">
            ...
            <div class="row">
                ...
                <div>
                    <form action="admin_form_especialidad.php">
            ...
            <div id="Tabla" class="table table-responsive">
                <table class="table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        $Informacion_SQL = Mostrar_Especialidades();

                        while ($Fila = sqlsrv_fetch_array($Informacion_SQL, SQLSRV_FETCH_ASSOC)) {
                        ?>
                            <tr>
                                <td>
                                    <p><?php echo utf8_encode($Fila['ID_esp']); ?></p>
                                </td>
                                <td>
                                    <p><?php echo utf8_encode($Fila['nombre_esp']); ?></p>
                                </td>
                                <td>
                                    <form action="edit_especialidad.php" method="post">
                                        <input type="hidden" name="ID_Especialidad" value="<?php echo utf8_encode($Fila['ID_esp']); ?>">
                                ...
                                <td>
                                    <form action="#" method="post">
                                        <input type="hidden" name="ID_Especialidad" value="<?php echo utf8_encode($Fila['ID_esp']); ?>">
                                        <button class="btn btn-outline-secondary" type="submit" name="borrar" onclick="return Confirmar_Borrado('<?php echo utf8_encode($Fila['ID_esp']); ?>')"><i class="fas fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                        <?php
