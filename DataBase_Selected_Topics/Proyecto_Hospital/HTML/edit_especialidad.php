...
if (isset($_POST['submit'])) {
    ...
    $Informacion = Editar_Especialidad($ID_Especialidad, $Nombre);
}
?>
    ...
    <div class="container-fluid" id="Principal">
        ...
        <div id="Contenido" style="margin-left: 25%; margin-right:5%;">
            ...
            if ($Informacion == 5) { ?>
                <div class="alert alert-danger alert-dismissible fade show">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>El Nombre ya se encuentra registrado.</strong> Por favor, intente nuevamente.
                </div>
            <?php
            }
            ?>
            <div class="row">
                <div class="col">
                    <h1>Editar Especialidad: ID <b><?php echo utf8_encode($ID_Especialidad); ?></b></h1>
                </div>
            </div>
            <?php
            //Buscamos los datos para mostrarlos
            $Fila = sqlsrv_fetch_array(Mostrar_Especialidad_Edit($ID_Especialidad), SQLSRV_FETCH_ASSOC);
            ?>
            <div class="container-fluid" id="Formulario">
                <form action="#" method="post">
                    <input type="hidden" name="ID_Especialidad" value="<?php echo utf8_encode($ID_Especialidad); ?>">
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" value="<?php echo utf8_encode($Fila['nombre_esp']); ?>" id="Nombre" name="Nombre" placeholder="Nombre" pattern="[A-Za-zÀ-ÿ0-9 ]{3,40}" maxlength="40" required>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-center boton container">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="admin_especialidades.php">
