...
if (isset($_POST['borrar'])) {
    ...
    $Informacion = Borrar_Paciente($NSS);
}
?>
    ...
    <div class="container-fluid" id="Principal">
        ...
        <div id="Contenido" style="margin-left: 25%; margin-right:5%;">
            ...
            <div class="row">
                ...
                <div class="col">
                    <form action="admin_form_paciente.php">
            ...
            <div id="Tabla" class="table table-responsive">
                <table class="table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        $Informacion_SQL = Mostrar_Pacientes();
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <p><?php echo utf8_encode($Fila['NSS']); ?></p>
                                </td>
                                <td>
                                    <p><?php echo utf8_encode($Fila['Status_pac']); ?></p>
                                </td>
                                <td>
                                    <p><?php echo utf8_encode($Fila['Cama']); ?></p>
                                </td>
                                <td>
                                    <p><?php echo utf8_encode($Fila['Tratamiento']); ?></p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <form action="edit_paciente.php" method="post">
                                        <input type="hidden" name="NSS" value="<?php echo utf8_encode($Fila['NSS']); ?>">
                                ...
                                <td>
                                    <form action="#" method="post">
                                        <input type="hidden" name="NSS" value="<?php echo utf8_encode($Fila['NSS']); ?>">
                                        <button class="btn btn-outline-secondary" type="submit" name="borrar" onclick="return Confirmar_Borrado('<?php echo utf8_encode($Fila['NSS']); ?>')"><i class="fas fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                        <?php
