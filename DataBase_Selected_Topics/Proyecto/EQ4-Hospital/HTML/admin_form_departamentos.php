...
if (isset($_POST['submit'])) {
    ...
    $Informacion = Agregar_Departamento($Nombre, $Extension);
}
?>
            ...
            <div class="container-fluid" id="Formulario">
                <form action="#" method="post">
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" value="" id="Nombre" name="Nombre" placeholder="Nombre" pattern="[A-Za-zÀ-ÿ0-9 ]{3,40}" maxlength="40" required>
                            </div>
                            <div class="col">
                                <input type="number" class="form-control" value="" id="Extension" name="Extension" placeholder="Extensión" pattern="[0-9]{3}" min="100" max = "999" required>
                            </div>
                        </div>
                    </div>
