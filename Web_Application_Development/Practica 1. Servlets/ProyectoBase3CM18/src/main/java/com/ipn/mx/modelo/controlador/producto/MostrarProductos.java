...
import com.ipn.mx.modelo.controlador.categoria.MostrarCategorias;
...
public class MostrarProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Mostrar Productos</title>"); 
            ...
            try {
                ...
                for(int i=0; i<resultado.size(); i++ ){
                    ...
                    out.println("<tr>");
                    out.println("<td><a href='VerProducto?id="+dto.getEntidad().getIdProducto()+"'class='btn  btn-warning'>"
                    ...
                    out.println("<td><a href='EliminarProducto?id="+dto.getEntidad().getIdProducto()+"' class='btn  btn-danger'>Eliminar</a></td>");
                    out.println("<td><a href='ActualizarProducto?id="+dto.getEntidad().getIdProducto()
