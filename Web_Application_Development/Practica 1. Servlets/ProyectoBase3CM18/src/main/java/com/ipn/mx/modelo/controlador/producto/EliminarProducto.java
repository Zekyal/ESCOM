...
public class EliminarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<META HTTP-EQUIV='REFRESH' CONTENT='3;URL=MostrarProductos'>");
            ...
            try {
                dto = dao.read(dto);
                out.println("<h2>El elemento eliminado de los productos fue:</h2><h3><p style='color:blue'>"
                        + dto.getEntidad().getNombreProducto()+ "</p></h3>");
                dao.delete(dto);
