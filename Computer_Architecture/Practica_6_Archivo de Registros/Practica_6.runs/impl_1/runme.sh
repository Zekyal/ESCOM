...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_6/Practica_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArchivodeRegistros.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArchivodeRegistros.tcl -notrace
