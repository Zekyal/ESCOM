...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_14_Unidad de Control/Practica_14_Unidad de Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Unidad_Control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Unidad_Control.tcl
