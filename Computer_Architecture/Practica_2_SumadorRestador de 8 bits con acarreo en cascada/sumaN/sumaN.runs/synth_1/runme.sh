...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/sumaN/sumaN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumaN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumaN.tcl
