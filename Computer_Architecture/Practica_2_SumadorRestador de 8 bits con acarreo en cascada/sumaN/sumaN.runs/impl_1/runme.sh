...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/sumaN/sumaN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumaN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumaN.tcl -notrace
