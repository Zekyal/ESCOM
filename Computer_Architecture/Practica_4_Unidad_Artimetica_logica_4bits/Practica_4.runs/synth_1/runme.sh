...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_4/Practica_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Nbits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_Nbits.tcl
