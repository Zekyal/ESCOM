...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_4/Practica_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Nbits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_Nbits.tcl -notrace
