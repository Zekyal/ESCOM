...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_6/Practica_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArchivodeRegistros.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArchivodeRegistros.tcl
