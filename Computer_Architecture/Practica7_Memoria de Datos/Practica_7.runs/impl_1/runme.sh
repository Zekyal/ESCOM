...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/Practica_7/Practica_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoriaDatos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemoriaDatos.tcl -notrace
