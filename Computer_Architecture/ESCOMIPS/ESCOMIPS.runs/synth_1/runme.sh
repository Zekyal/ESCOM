...
HD_PWD='C:/Users/146261/Documents/IPN ESCOM/Arquitectura de Computadoras/ESCOMIPS/ESCOMIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ESCOMIPS_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ESCOMIPS_tb.tcl
