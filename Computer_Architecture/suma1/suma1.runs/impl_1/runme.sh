...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/suma1/suma1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log suma1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source suma1.tcl -notrace
