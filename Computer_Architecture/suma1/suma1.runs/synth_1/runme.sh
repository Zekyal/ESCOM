...
HD_PWD='C:/Users/User-Pc/Documents/Arquitectura/suma1/suma1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log suma1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source suma1.tcl
